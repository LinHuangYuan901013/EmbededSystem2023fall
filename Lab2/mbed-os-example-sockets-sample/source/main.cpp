...
private:
    ...
    // }
     ...
     bool send_http_request(int sample_num) {
        ...
        float x = (float)((int)(pDataXYZ[0]*10000))/10000;
        int y = pDataXYZ[1],z = pDataXYZ[2];
        printf("\nACCELERO_X = %d\n", pDataXYZ[0]);
        printf("ACCELERO_Y = %d\n", pDataXYZ[1]);
        printf("ACCELERO_Z = %d\n", pDataXYZ[2]);
        ...
        // int len = sprintf(acc_json,"{\"x\":%f,\"y\":2,\"z\":1,\"s\":1}",x);
        // int len = sprintf(acc_json,"{\"x\":5,\"y\":2,\"z\":1,\"s\":1}");
